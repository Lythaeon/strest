...
- `--no-ua` disables the default `User-Agent: strest-loadtest/<version>` header.
...
By default, strest sends `User-Agent: strest-loadtest/<version>`; set `no_ua = true` to disable.
